...
public class BoardController {
	 ...
	 * { if (bindingResult.hasErrors()) { return "/board/write"; } else {
	 ...
	 * public String edit(@PathVariable int seq, Model model) { BoardVO boardVO
	 ...
	 * public String edit(@Valid @ModelAttribute BoardVO boardVO, BindingResult
	 * result, int pwd, SessionStatus sessionStatus, Model model)
	 */
	 ...
	 * Refactoring 전 코드
	 * 
	 * @RequestMapping(value = "/board/delete/{seq}", method =
	 * RequestMethod.GET) public String delete(@PathVariable int seq, Model
	 * model) { model.addAttribute("seq", seq); return "/board/delete"; }
	 */
